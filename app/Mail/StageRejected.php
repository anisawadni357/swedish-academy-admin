    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                ...
                'review_date' => $this->studentStageCourse->updated_at ? $this->studentStageCourse->updated_at->format('F d, Y') : now()->format('F d, Y'),
                'admin_notes' => $this->studentStageCourse->admin_notes ?? 'No specific notes provided.',
                'resubmit_url' => config('app.user_url') . '/courses/' . $this->studentStageCourse->product_id,
