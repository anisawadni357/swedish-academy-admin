...
class StudentSuccessRejected extends Mailable
{
    ...
    {
        return new Content(
            view: 'emails.student-success-rejected',
            with: [
                ...
                'review_date' => now()->format('F d, Y'),
                'admin_notes' => 'Please review the feedback provided in your dashboard.',
                'product' => $this->studentSuccess->product,
                'studentSuccess' => $this->studentSuccess,
                'resubmit_url' => config('app.user_url') . '/student-dashboard/courses/' . $this->studentSuccess->product_id,
            ],
        );
    }
