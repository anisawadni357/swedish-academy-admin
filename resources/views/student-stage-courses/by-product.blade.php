...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">Internship Submissions by Product</h1>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('student-stage-courses.by-product') }}" class="row">
                        <div class="col-md-4">
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0">{{ $groupedSubmissions->count() }}</h4>
                    <small>Courses with Internships</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0">{{ $groupedSubmissions->flatten()->count() }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0">{{ $groupedSubmissions->flatten()->where('is_valid', 0)->count() }}</h4>
                    <small>Pending</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body text-center">
                    ...
                    <h4 class="mb-0">{{ $groupedSubmissions->flatten()->where('is_valid', 1)->count() }}</h4>
                ...
                <div class="card-body">
                    @if($groupedSubmissions->count() > 0)
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach($groupedSubmissions as $index => $submissions)
                                        @php
                                            $firstSubmission = $submissions->first();
                                            $product = $firstSubmission ? $firstSubmission->product : null;
                                            $pendingCount = $submissions->where('is_valid', 0)->count();
                                            $validatedCount = $submissions->where('is_valid', 1)->count();
                                            $rejectedCount = $submissions->where('is_valid', -1)->count();
                                        @endphp
                                        <tr>
                                            ...
                                            <td>
                                                @if($product)
                                                    <a href="{{ route('student-stage-courses.index', ['product_id' => $product->id]) }}" 
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">
                                There are no internship submissions matching your criteria.
                            </p>
                        </div>
                    @endif
                </div>
