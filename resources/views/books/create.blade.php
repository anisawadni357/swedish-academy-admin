            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">New Book</h4>
                            <p class="text-muted mb-0">Add a new book to the library</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="titre_ar" class="form-control @error('titre_ar') is-invalid @enderror" 
                                                   value="{{ old('titre_ar') }}" required placeholder="Book title in Arabic">
                                            @error('titre_ar')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_short_ar" class="form-control @error('description_short_ar') is-invalid @enderror" 
                                                      rows="3" placeholder="Short description in Arabic">{{ old('description_short_ar') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_ar" id="description_ar" class="form-control @error('description_ar') is-invalid @enderror" 
                                                      rows="6" placeholder="Full description in Arabic">{{ old('description_ar') }}</textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="titre_en" class="form-control @error('titre_en') is-invalid @enderror" 
                                                   value="{{ old('titre_en') }}" required placeholder="Book title in English">
                                            @error('titre_en')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_short_en" class="form-control @error('description_short_en') is-invalid @enderror" 
                                                      rows="3" placeholder="Short description in English">{{ old('description_short_en') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description_en" id="description_en" class="form-control @error('description_en') is-invalid @enderror" 
                                                      rows="6" placeholder="Full description in English">{{ old('description_en') }}</textarea>
                                         ...
                                         <div class="row">
                                             ...
                                             <div class="col-md-3">
                                                 <div class="mb-3">
                                                     ...
                                                     <div class="form-text">Accepted formats: PDF, DOC, DOCX, EPUB (max 10MB)</div>
                                                     @error('file')
                                                         <div class="invalid-feedback">{{ $message }}</div>
                                                     @enderror
                                                 </div>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <div class="input-group">
                                                         <input type="number" name="prix" class="form-control @error('prix') is-invalid @enderror" 
                                                                value="{{ old('prix', 0) }}" required min="0" step="0.01" placeholder="0.00">
