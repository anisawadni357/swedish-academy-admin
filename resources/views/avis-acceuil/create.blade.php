            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">Create a new customer testimonial</h4>
                            <p class="text-white-50 mb-0">Add a new customer testimonial</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('avis-acceuil.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('avis_en') is-invalid @enderror" 
                                                              ...
                                                              placeholder="Enter the testimonial in English">{{ old('avis_en') }}</textarea>
                                                    @error('avis_en')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('avis_ar') is-invalid @enderror" 
                                                              ...
                                                              placeholder="Enter the testimonial in Arabic">{{ old('avis_ar') }}</textarea>
                                                    @error('avis_ar')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
