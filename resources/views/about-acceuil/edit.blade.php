            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">Edit About section</h4>
                            <p class="text-white-50 mb-0">Edit the content of the "About" section</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('about-acceuil.update', $aboutAcceuil) }}" method="POST">
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                              ...
                                                              placeholder="Enter the description in English">{{ old('description_en', $aboutAcceuil->description_en) }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                                              ...
                                                              placeholder="Enter the description in Arabic">{{ old('description_ar', $aboutAcceuil->description_ar) }}</textarea>
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                                               {{ old('is_active', $aboutAcceuil->is_active) ? 'checked' : '' }}>
