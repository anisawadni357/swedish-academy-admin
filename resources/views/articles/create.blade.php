            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">Create a new article</h4>
                            <p class="text-white-50 mb-0">Add a new article with multilingual content</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description_short_ar') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Short description for preview...">{{ old('description_short_ar') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        // Ensure CKEditor fields are filled
        ...
        if (descriptionAr.value.trim() === '') {
            e.preventDefault();
            alert('Please fill the Arabic description');
            return false;
        }
        
        if (descriptionEn.value.trim() === '') {
            e.preventDefault();
            alert('Please fill the English description');
            return false;
        }
    });
});
