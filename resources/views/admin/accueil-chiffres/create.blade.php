            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">Create New Homepage Statistics</h4>
                            <p class="text-white-50 mb-0">Add new statistics with icons for the homepage</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('accueil-chiffres.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="coach_ready" name="coach_ready" 
                                                   value="{{ old('coach_ready') }}" min="0" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="icone_coach_ready" class="form-label">Icon</label>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="book_of_the_academy" name="book_of_the_academy" 
                                                   value="{{ old('book_of_the_academy') }}" min="0" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="icone_book_of_the_academy" class="form-label">Icon</label>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="registered_student" name="registered_student" 
                                                   value="{{ old('registered_student') }}" min="0" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="icone_registered_student" class="form-label">Icon</label>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="training_program" name="training_program" 
                                                   value="{{ old('training_program') }}" min="0" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="icone_training_program" class="form-label">Icon</label>
