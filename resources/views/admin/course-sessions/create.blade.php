        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create New Course Session</h4>
                </div>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form method="POST" action="{{ route('admin.course-sessions.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="e.g., Chapter 5: Introduction to Functions">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('session_type') is-invalid @enderror" id="session_type" name="session_type" required>
                                    ...
                                    <option value="online" {{ old('session_type') == 'online' ? 'selected' : '' }}>Online (Zoom/Virtual)</option>
                                    <option value="classroom" {{ old('session_type') == 'classroom' ? 'selected' : '' }}>Classroom</option>
                                </select>
                                @error('session_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('instructor_name') is-invalid @enderror" id="instructor_name" name="instructor_name" value="{{ old('instructor_name') }}">
                        ...
                        <div class="mb-3" id="location_field" style="display: none;">
                            ...
                            <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}" placeholder="e.g., Room 301, Building A">
                            @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div id="online_fields" style="display: none;">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('zoom_meeting_id') is-invalid @enderror" id="zoom_meeting_id" name="zoom_meeting_id" value="{{ old('zoom_meeting_id') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" class="form-control @error('zoom_join_url') is-invalid @enderror" id="zoom_join_url" name="zoom_join_url" value="{{ old('zoom_join_url') }}" placeholder="https://zoom.us/j/...">
                                    @error('zoom_join_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Any special instructions or reminders for students.</div>
                        </div>

                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.course-sessions.index') }}" class="btn btn-outline-secondary">Cancel</a>
                            <button type="submit" class="btn btn-primary">
                                <i data-feather="save" class="me-1"></i> Create Session
                            </button>
                        </div>
                    </form>
                </div>
