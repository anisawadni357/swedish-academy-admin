...
@section('title', 'Create New Coupon - Marketing')
                    ...
                    <form action="{{ route('coupons.store') }}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="manual_code" name="manual_code"
                                                       {{ old('manual_code') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="manual_code">
                                                    <i class="fa fa-code me-2"></i><strong>Enter Custom Code</strong>
                                                    <div class="form-text">Toggle to enter a custom coupon code, otherwise auto-generate</div>
                                                </label>
                                            </div>
                                        </div>

                                        <div class="mb-3" id="code-field" style="display: {{ old('manual_code') ? 'block' : 'none' }};">
                                            <label for="code" class="form-label">
                                                <i class="fa fa-ticket-alt me-2"></i>Coupon Code
                                            </label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text" id="valeur-unit">%</span>
                                            </div>
                                            @error('valeur')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('limit_utilise') is-invalid @enderror"
                                   id="limit_utilise" name="limit_utilise" value="{{ old('limit_utilise') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('customer_type') is-invalid @enderror" id="customer_type" name="customer_type" required>
                                <option value="all" {{ old('customer_type') == 'all' ? 'selected' : '' }}>All Customers</option>
                                <option value="new" {{ old('customer_type') == 'new' ? 'selected' : '' }}>New Customers Only</option>
                                <option value="returning" {{ old('customer_type') == 'returning' ? 'selected' : '' }}>Returning Customers</option>
                                <option value="vip" {{ old('customer_type') == 'vip' ? 'selected' : '' }}>VIP Customers</option>
                            </select>
                            @error('customer_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('custom_message') is-invalid @enderror"
                                      ...
                                      placeholder="Optional message to display with this coupon">{{ old('custom_message') }}</textarea>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="is_active">
                                <i class="fa fa-toggle-on me-2"></i><strong>Active</strong>
                                <div class="form-text">Enable this coupon for use.</div>
                            </label>
                        </div>

                        <div class="alert alert-info">
                            <i class="fa fa-info-circle me-2"></i>
                            <strong>Note:</strong> The coupon code will be generated automatically.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('min_purchase_amount') is-invalid @enderror"
                                   id="min_purchase_amount" name="min_purchase_amount" value="{{ old('min_purchase_amount') }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('min_cart_items') is-invalid @enderror"
                                   id="min_cart_items" name="min_cart_items" value="{{ old('min_cart_items', 1) }}"
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox"
                                   ...
                                   {{ old('first_purchase_only') ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox"
                                   ...
                                   {{ old('cumulative_enabled') ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="is_public">
                                <i class="fa fa-eye me-2"></i><strong>Public Coupon</strong>
                                <div class="form-text">Make this coupon visible to all customers without a code.</div>
                            </label>
                        </div>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox"
                                   ...
                                   {{ old('allow_multiple_uses') ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('affiliate_partner_id') is-invalid @enderror"
                                ...
                                @foreach($affiliatePartners ?? [] as $affiliate)
                                    <option value="{{ $affiliate->id }}" {{ old('affiliate_partner_id') == $affiliate->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3" id="commission_rate_field" style="display: none;">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex gap-3 flex-wrap">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="product_application" id="all_products" value="all" {{ old('product_application', 'selected') == 'all' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="all_products">
                                                        <i class="fa fa-globe me-1"></i>All Products
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="product_application" id="by_category" value="category" {{ old('product_application', 'selected') == 'category' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="by_category">
                                                        <i class="fa fa-tags me-1"></i>By Category
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="product_application" id="selected_products" value="selected" {{ old('product_application', 'selected') == 'selected' ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-4" id="category_selection_container" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        // Check if at least one product is selected (only if "Selected Products" is chosen)
        const selectedProductsRadio = document.getElementById('selected_products');
        if (selectedProductsRadio.checked) {
            const productCheckboxes = this.querySelectorAll('input[name="products[]"]:checked');
            if (productCheckboxes.length === 0) {
                console.log('No products selected');
                alert('Please select at least one product when "Selected Products Only" is chosen');
                e.preventDefault();
                return false;
            }
        }
    ...
    // Manual code toggle functionality
    const manualCodeToggle = document.getElementById('manual_code');
    const codeField = document.getElementById('code-field');
    const codeInput = document.getElementById('code');

    manualCodeToggle.addEventListener('change', function() {
        if (this.checked) {
    ...
    // Auto uppercase transformation for code input
    if (codeInput) {
