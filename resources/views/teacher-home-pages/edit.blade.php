        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="text-white-50 mb-0">Update teacher information</p>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('teacher-home-pages.update', $teacherHomePage) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="name_ar" 
                                           name="name_ar" 
                                           value="{{ old('name_ar', $teacherHomePage->name_ar) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="name_en" 
                                           name="name_en" 
                                           value="{{ old('name_en', $teacherHomePage->name_en) }}" 
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img src="{{ $teacherHomePage->image_url }}" alt="Current" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="image" class="form-label">
                                        <i class="fa fa-image me-1"></i>
                                        <strong>{{ $teacherHomePage->image ? 'Change Image' : 'Teacher Image' }}</strong>
                                    </label>
                                    <input type="file" 
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="order" 
                                           name="order" 
                                           value="{{ old('order', $teacherHomePage->order) }}" 
                                           min="0">
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch" style="font-size: 1.2rem; padding-top: 0.3rem;">
                                        <input class="form-check-input" 
                                               ...
                                               name="is_active" 
                                               value="1"
                                               {{ old('is_active', $teacherHomePage->is_active) ? 'checked' : '' }}>
