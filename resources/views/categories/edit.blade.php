                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="text-white-50 mb-0">Update the category information</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('categories.update', $category) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('titre') is-invalid @enderror" 
                                   id="titre" name="titre" value="{{ old('titre', $category->titre) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('titre_en') is-invalid @enderror" 
                                   id="titre_en" name="titre_en" value="{{ old('titre_en', $category->titre_en) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('titre_ar') is-invalid @enderror" 
                                   id="titre_ar" name="titre_ar" value="{{ old('titre_ar', $category->titre_ar) }}" 
