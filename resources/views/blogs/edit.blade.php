            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-1">Modifier l'article</h4>
                            <p class="text-white-50 mb-0">Modifiez le contenu de l'article "{{ $blog->titre_en }}"</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('titre_ar') is-invalid @enderror" 
                                                       id="titre_ar" name="titre_ar" value="{{ old('titre_ar', $blog->titre_ar) }}" required>
                                                @error('titre_ar')
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('meta_title_ar') is-invalid @enderror" 
                                                       id="meta_title_ar" name="meta_title_ar" value="{{ old('meta_title_ar', $blog->meta_title_ar) }}" required>
                                                @error('meta_title_ar')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description_short_ar') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Description courte pour l'aperçu...">{{ old('description_short_ar', $blog->description_short_ar) }}</textarea>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                                          id="description_ar" name="description_ar" required>{{ old('description_ar', $blog->description_ar) }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('titre_en') is-invalid @enderror" 
                                                       id="titre_en" name="titre_en" value="{{ old('titre_en', $blog->titre_en) }}" required>
                                                @error('titre_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('meta_title_en') is-invalid @enderror" 
                                                       id="meta_title_en" name="meta_title_en" value="{{ old('meta_title_en', $blog->meta_title_en) }}" required>
                                                @error('meta_title_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description_short_en') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Short description for preview...">{{ old('description_short_en', $blog->description_short_en) }}</textarea>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                          id="description_en" name="description_en" required>{{ old('description_en', $blog->description_en) }}</textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @if($blog->image)
                                                    <div class="mb-2">
                                                        <img src="{{ asset('uploads/blogs/' . $blog->image) }}" alt="Image actuelle" class="img-thumbnail" style="max-width: 200px;">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('author_ar') is-invalid @enderror" 
                                                       id="author_ar" name="author_ar" value="{{ old('author_ar', $blog->author_ar) }}">
                                                @error('author_ar')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('author_en') is-invalid @enderror" 
                                                       id="author_en" name="author_en" value="{{ old('author_en', $blog->author_en) }}">
                                                @error('author_en')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="date" class="form-control @error('published_date') is-invalid @enderror" 
                                                       id="published_date" name="published_date" value="{{ old('published_date', $blog->published_date ? $blog->published_date->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $blog->id }}" readonly>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label">Créé le</label>
                                                <input type="text" class="form-control" value="{{ $blog->created_at->format('d/m/Y H:i') }}" readonly>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label">Modifié le</label>
                                                <input type="text" class="form-control" value="{{ $blog->updated_at->format('d/m/Y H:i') }}" readonly>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label">Vues</label>
                                                <input type="text" class="form-control" value="{{ $blog->views_count }} vues" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
